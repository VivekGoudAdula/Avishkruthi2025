...
const eventData: EventData = {
  ...
  description: 'War of Words is a high-stakes simulation that puts leadership, teamwork, and problem-solving to the ultimate test. Teams face unexpected crisis scenarios such as PR disasters, financial collapses, or supply chain failures. With limited time, they must collaborate, think on their feet, and present actionable strategies to manage the chaos and minimize damage.',
  rules: [
    {
      title: 'Rules & Regulations',
      items: [
        'Each team will be given a simulated crisis scenario (e.g., PR disaster, financial collapse, supply chain disruption)',
        'Preparation time: 30 minutes per scenario',
        'Presentation time: 5 minutes to deliver the crisis action plan',
        'Teams will be judged on quick thinking, feasibility, leadership, teamwork, and clarity of presentation',
  ...
  contacts: [
    { name: 'Ajay', number: '9550031685' },
    { name: 'Yashwanth', number: '7702477424' }
  ]
};

const WarOfWordsPage: React.FC = () => {
          ...
          <div className="space-y-8">
            ...
            <div className="pt-6 border-t border-gray-700">
              <p className="text-gray-400 text-sm">
                Ready to test your crisis management skills? Register now and prove your strategic thinking under pressure!
              </p>
            </div>
          </div>
        </div>
