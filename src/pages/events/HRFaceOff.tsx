...
const eventData: EventData = {
  ...
  participation: 'Team Event (2-4 members)',
  description: 'HR Face Off is a dynamic and interactive competition that tests leadership, negotiation, and people management skills. In this two-round activity, participants first build their teams through a creative challenge, and then step into HR roles to tackle real-life workplace scenarios through roleplay. This competition emphasizes empathy, communication, and decision-making under pressure, making it a true test of HR excellence.',
  rules: [
    {
      title: 'Round 1: Team Building Challenge',
      items: [
        'Teams will participate in a team-building activity',
        'Demonstrate collaboration, leadership, and communication skills',
        'Judges will evaluate team dynamics and problem-solving approaches'
      ]
    },
    {
      title: 'Round 2: Roleplay Scenario',
      items: [
        'Teams will be given a workplace scenario to enact and solve',
        'Must demonstrate HR skills in handling the situation',
        'Focus on empathy, communication, and fair decision-making'
      ]
    },
    {
      title: 'General Rules & Guidelines',
      items: [
        'Each team gets 30 minutes of preparation time per round',
        'Presentation time: 5–7 minutes per round',
        'Judging criteria: Communication, negotiation, empathy, creativity, and leadership',
  ...
  contacts: [
    { name: 'Vrishank', number: '9490056510' },
    { name: 'Srikanth', number: '9014438643' }
  ]
};

const HRFaceOffPage: React.FC = () => {
