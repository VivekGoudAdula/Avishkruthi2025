...
const eventData: EventData = {
  ...
  description: 'Strategy Masters is a battle of innovation and strategic thinking where teams must design winning business strategies for real-world or fictional market scenarios. From launching a product in a competitive market to navigating industry challenges, participants will analyze, plan, and present bold yet practical strategies that stand out.',
  rules: [
    {
      title: 'Rules & Regulations',
      items: [
        'Each team will be given a business scenario (real-world or fictional)',
        'Preparation time: 30 minutes for research and planning',
        'Presentation time: 5 – 7 minutes to showcase the strategy',
        'Teams will be judged on creativity, practicality, analytical ability, and strategic thinking',
...
const StrategyMastersPage: React.FC = () => {
          ...
          <div className="space-y-8">
            ...
            <div className="pt-6 border-t border-gray-700">
              <p className="text-gray-400 text-sm">
                Ready to showcase your strategic thinking? Register now and prove your business acumen!
              </p>
            </div>
          </div>
        </div>
...
export default StrategyMastersPage;
