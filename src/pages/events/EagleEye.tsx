...
const eventData: EventData = {
  ...
  description: 'Eagle Eye is a fun and fast-paced puzzle-solving competition that puts your observation skills to the ultimate test. Teams must spot hidden errors, patterns, or business-related clues within the shortest time possible. Accuracy, speed, and attention to detail will decide who truly has the sharpest eyes in the room.',
  rules: [
    {
      title: 'Rules & Regulations',
      items: [
        'The event will be conducted in multiple rounds',
        'Teams will be given clue sheets, images, or videos with hidden details',
        'Each round will have a time limit of 10 minutes',
        'Teams must identify and submit the maximum correct answers within the time',
        'Winners will be decided based on speed and accuracy',
  ...
  contacts: [
    ...
    { name: 'Himasagar', number: '8341670317' }
  ]
};

const EagleEyePage: React.FC = () => {
          ...
          <div className="space-y-8">
            ...
            <div className="pt-6 border-t border-gray-700">
              <p className="text-gray-400 text-sm">
                Ready to test your observation skills? Register now and prove you have the sharpest eyes in the room!
              </p>
            </div>
          </div>
        </div>
