...
const eventData: EventData = {
  ...
  description: 'Meme Mania is a fun activity where participants create memes on given topics. They can use humor, creativity, and design skills to make the best memes. The focus is on originality and how well the meme connects with the audience.',
  participation: 'Group and Individual can participate – Group size: Minimum 2, Maximum 4',
  rules: [
    'Memes must be original (no plagiarism).',
    'Memes should not contain offensive or inappropriate content.',
    'Participants must create memes only on the given topic/theme.',
    'Each team/individual can submit only one final meme.',
